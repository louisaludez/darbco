...
CREATE TABLE `production_data` (
  ...
  CONSTRAINT `fk_production_worker` FOREIGN KEY (`worker_id`) REFERENCES `workers` (`worker_id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `production_data` VALUES (2,1,'2026-05-13',13,12,0,0,0,0,0,0,1,'12','1212','16:09:00','16:09:00','23:21:00','s','3213','Block A, Farm 2','32242',2,'2026-05-13 08:12:38','2026-05-13 08:12:38'),(3,1,'2026-05-13',1,1,0,0,0,0,0,0,3,'ee','d',NULL,NULL,NULL,'','','','',2,'2026-05-13 08:13:00','2026-05-13 08:13:00');
...
INSERT INTO `production_stem_details` VALUES (1,2,11,1),(2,2,12,3),(3,2,13,3),(4,2,14,1);
...
-- Dump completed on 2026-05-29 13:42:01
