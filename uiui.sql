...
CREATE TABLE `packing_sessions` (
  ...
  CONSTRAINT `fk_session_recorder` FOREIGN KEY (`recorded_by`) REFERENCES `users` (`user_id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
INSERT INTO `production_data` VALUES (1,1,'2026-04-15',12,0,NULL,'Block A, Farm 2','df',2,'2026-04-15 00:58:24','2026-04-15 00:58:24');
...
INSERT INTO `workers` VALUES (1,NULL,'SALUDEZ','LOUI','09700909910',0,'2026-04-15 00:57:34','2026-04-15 00:58:54');
...
-- Dump completed on 2026-04-20  7:55:22
