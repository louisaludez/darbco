                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="group_number" id="group_number" class="form-select">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="number" name="stems_cut" id="stems_cut" class="form-control"
                                       min="0" placeholder="0">
                            </div>
                            <div class="col-md-2">
                                ...
                                <input type="number" name="boxes_produced" id="boxes_produced" class="form-control"
                                       min="0" required placeholder="auto or manual">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <label class="form-label fw-semibold mb-0">
                                        <i class="bi bi-grid-3x2-gap me-1 text-success"></i>Box Breakdown (Class A &amp; B)
                                    </label>
                                    <div class="d-flex gap-2">
                                        <button type="button" class="btn btn-sm btn-outline-success" id="addClassARow">
                                            <i class="bi bi-plus"></i> Class A
                                        </button>
                                        <button type="button" class="btn btn-sm btn-outline-warning" id="addClassBRow">
                                            <i class="bi bi-plus"></i> Class B
                                        </button>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-sm table-bordered" id="breakdownTable">
                                        <thead class="table-dark">
                                            <tr>
                                                ...
                                                <th>Box Spec</th>
                                                <th style="width:100px">Tally</th>
                                                <th style="width:100px">Adj.</th>
                                                <th style="width:110px">Should Be</th>
                                ...
                                <div class="text-muted small"><i class="bi bi-info-circle me-1"></i>Leave blank to skip breakdown. Total Boxes above will be used for payroll.</div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-secondary" id="addMaterialRow">
                ...
                <form method="POST" action="index.php?page=production&action=update">
                    ...
                    <div class="modal-body">
                        <div class="alert alert-info py-2 small">
                            <i class="bi bi-info-circle me-1"></i>Box breakdown &amp; materials cannot be edited after creation. Delete and recreate to change them.
                        </div>
                        <div class="row g-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <label class="form-label fw-semibold">Worker / ARB *</label>
                            ...
                            <div class="col-md-2">
                                <label class="form-label fw-semibold">Group</label>
                                <select name="group_number" id="edit_group_number" class="form-select">
                                    <option value="">-- Group --</option>
                                    <option value="1">Group 1</option>
                                    <option value="3">Group 3</option>
                                </select>
                            ...
                            <div class="col-md-2">
                                <label class="form-label fw-semibold">Stems Cut</label>
                                <input type="number" name="stems_cut" id="edit_stems_cut" class="form-control" min="0">
                            </div>
                            <div class="col-md-2">
                                <label class="form-label fw-semibold">Total Boxes *</label>
...
<script>
// ── Box spec presets ─────────────────────────────────────────
const CLASS_A_SPECS = ['4 Hands','5 Hands','6 Hands','7 Hands','8 Hands','9 Hands','4.7k','7.2k','BCP'];
const CLASS_B_SPECS = ['4/5/6 Hands','Small H / Clusters','F.P'];
...
function buildBreakdownRow(cls, specs) {
    ...
    return `<tr>
        ...
        <td>
            <select name="bk_spec[]" class="form-select form-select-sm">
                <option value="">-- Spec --</option>
                ${buildSpecOptions(specs)}
            </select>
        </td>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('breakdownRows')?.addEventListener('click', (e) => {
        if (e.target.closest('.remove-breakdown-row')) {
            e.target.closest('tr').remove();
        }
    });

    // ── Material row insertion ───────────────────────────────
    ...
    addMaterialBtn?.addEventListener('click', () => {
        ...
        row.innerHTML = `
            <div class="col-7">${firstSelect}</div>
            <div class="col-4"><input type="number" name="quantity_used[]" class="form-control form-control-sm" placeholder="Qty used" step="0.01" min="0"></div>
            <div class="col-1"><button type="button" class="btn btn-sm btn-outline-danger remove-material-row"><i class="bi bi-trash"></i></button></div>`;
